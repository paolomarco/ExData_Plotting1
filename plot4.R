...
par(mfrow=c(2,2))
with(consumption_data,plot(DT,Global_active_power,col='white',xlab = "",ylab = "Global Active Power"))
lines(consumption_data$DT,consumption_data$Global_active_power)

with(consumption_data,plot(DT,Voltage,col='white',xlab = "dateTime",ylab = "Voltage"))
lines(consumption_data$DT,consumption_data$Voltage)
...
with(consumption_data,plot(DT,Global_reactive_power,col='white',xlab = "dateTime",ylab = "Global Reactive Power"))
lines(consumption_data$DT,consumption_data$Global_reactive_power)
dev.off()
